  ...
  const sounds = [
    {
      ...
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/443/443.mp3',
    ...
    },
    {
      ...
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/135/135.mp3',
    ...
    },
    {
      ...
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/480/480.mp3',
    ...
    },
    {
      ...
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/234/234.mp3',
    ...
    },
    {
      ...
      description: 'Beat hip-hop/chill dịu, không gắt và không nhựa.',
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/282/282.mp3',
    ...
    },
    {
      ...
      category: 'LOFI',
      soundUrl: 'https://assets.mixkit.co/music/640/640.mp3',
    ...
    },
    {
      ...
      description: 'Mưa nhẹ đều, ít chi tiết thừa để dễ loop.',
      category: 'RAIN',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2393/2393-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1519692933481-e162a57d6721?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Rain Long Loop',
      description: 'Mưa dài, nền ổn cho tập trung hoặc ngủ ngắn.',
      category: 'RAIN',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2394/2394-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1438449805896-28a666819a20?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Light Rain Atmosphere',
      description: 'Mưa mỏng và thoáng, không quá ồn.',
      category: 'RAIN',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2474/2474-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Sea Waves With Birds',
      description: 'Sóng biển và chim xa, hợp bài thở chậm.',
      category: 'NATURE',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/1185/1185-preview.mp3',
    ...
    },
    {
      ...
      description: 'Suối nước sạch, nghe tự nhiên hơn tiếng synth.',
      category: 'NATURE',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/3126/3126-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1474440692490-2e83ae13ba29?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'River In The Forest With Birds',
      description: 'Nước chảy và chim rừng, nhẹ nhàng để nghỉ mắt.',
      category: 'NATURE',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/1216/1216-preview.mp3',
    ...
    {
      title: 'Morning Birds',
      description: 'Chim sáng vừa đủ, không chói tai.',
      category: 'NATURE',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2472/2472-preview.mp3',
    ...
    },
    {
      ...
      description: 'Gió nền rộng, hợp thiền và kéo giãn.',
      category: 'AMBIENT',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2658/2658-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1505672678657-cc7037095e60?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Campfire Night Wind',
      description: 'Lửa trại và gió đêm, ấm nhưng không quá kịch.',
      category: 'AMBIENT',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/1736/1736-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1475139441338-693e7dbe20b6?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Campfire Crackles',
      description: 'Tiếng củi nổ nhỏ, hợp màn nghỉ cuối ngày.',
      category: 'AMBIENT',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/1330/1330-preview.mp3',
    ...
    },
    {
      ...
      description: 'Không khí rừng đêm dịu, phù hợp thư giãn trước ngủ.',
      category: 'SLEEP',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2414/2414-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1532978879514-6cfa608be43c?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Summer Night Crickets',
      description: 'Dế đêm đều, ít biến động để dễ chìm vào giấc.',
      category: 'SLEEP',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/1789/1789-preview.mp3',
    ...
    },
    {
      ...
      description: 'Âm nền văn phòng nhẹ cho chế độ tập trung.',
      category: 'FOCUS',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/447/447-preview.mp3',
      imageUrl: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=600',
      duration: 30,
      isActive: true,
    },
    {
      title: 'Slow Typing On A Keyboard',
      description: 'Tiếng gõ phím chậm, dùng khi cần nền làm việc.',
      category: 'FOCUS',
      soundUrl: 'https://assets.mixkit.co/active_storage/sfx/2532/2532-preview.mp3',
