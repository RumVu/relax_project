# relax_api_client.model.UpdateTierDto
...
------------ | ------------- | ------------- | -------------
**name** | **String** | Unique internal code, UPPER_SNAKE only. E.g. CHILL_PLUS, CHILL_PLUS_ANNUAL. | [optional] 
...
**price** | **num** | List price in the smallest visible unit (e.g. VND). | [optional] 
