...
// tests for AppThemeResponseDto
void main() {
  final instance = AppThemeResponseDtoBuilder();
  // TODO add properties to the builder and call build()

  group(AppThemeResponseDto, () {
    // String id
    ...
    // String surfaceColor
    test('to test the property `surfaceColor`', () async {
      // TODO
    });
    ...
    test('to test the property `mutedTextColor`', () async {
      // TODO
    });
