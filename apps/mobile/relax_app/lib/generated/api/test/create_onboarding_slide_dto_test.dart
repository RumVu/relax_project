...
// tests for CreateOnboardingSlideDto
void main() {
  final instance = CreateOnboardingSlideDtoBuilder();
  // TODO add properties to the builder and call build()

  group(CreateOnboardingSlideDto, () {
    // String title
    ...
    // String animationUrl
    test('to test the property `animationUrl`', () async {
      // TODO
    });
