...
class AnalyticsApi {
  ...
  Future<Response<JsonObject>> analyticsControllerGetContracts({ 
    ...
    final _path = r'/v1/analytics/contracts';
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> analyticsControllerGetOverview({ 
    String? period,
    ...
    final _path = r'/v1/analytics/me/overview';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
