...
part 'create_app_theme_dto.g.dart';
...
/// * [isActive] 
@BuiltValue()
abstract class CreateAppThemeDto implements Built<CreateAppThemeDto, CreateAppThemeDtoBuilder> {
  ...
  factory CreateAppThemeDto([void updates(CreateAppThemeDtoBuilder b)]) = _$CreateAppThemeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateAppThemeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateAppThemeDto> get serializer => _$CreateAppThemeDtoSerializer();
}

class _$CreateAppThemeDtoSerializer implements PrimitiveSerializer<CreateAppThemeDto> {
  @override
  final Iterable<Type> types = const [CreateAppThemeDto, _$CreateAppThemeDto];

  @override
  final String wireName = r'CreateAppThemeDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateAppThemeDto object, {
  ...
  void _deserializeProperties(
    ...
    required CreateAppThemeDtoBuilder result,
  ...
  @override
  CreateAppThemeDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateAppThemeDtoBuilder();
