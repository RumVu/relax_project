...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerChangeMyPassword({ 
    ...
    final _path = r'/v1/auth/me/password';
    ...
    AuthActionResultDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthActionResultDto),
      ) as AuthActionResultDto;
    ...
    return Response<AuthActionResultDto>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerDeleteMine({ 
    ...
    try {
      const _type = FullType(DeleteAccountDto);
      _bodyData = _serializers.serialize(deleteAccountDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponseDto>> authControllerDemo({ 
    required DemoLoginDto demoLoginDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DemoLoginDto);
      _bodyData = _serializers.serialize(demoLoginDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> authControllerExportMine({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/auth/me/export';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponseDto>> authControllerGoogle({ 
    required GoogleLoginDto googleLoginDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GoogleLoginDto);
      _bodyData = _serializers.serialize(googleLoginDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponseDto>> authControllerLogin({ 
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerLogout({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponseDto>> authControllerMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponseDto>> authControllerRefresh({ 
    required RefreshTokenDto refreshTokenDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthResponseDto>> authControllerRegister({ 
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerRequestEmailVerification({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/auth/me/email-verification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerRequestPasswordReset({ 
    ...
    final _path = r'/v1/auth/password-reset/request';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerResetPassword({ 
    ...
    final _path = r'/v1/auth/password-reset/confirm';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthActionResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthActionResultDto>> authControllerVerifyEmail({ 
