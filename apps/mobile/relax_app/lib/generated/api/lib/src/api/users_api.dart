...
class UsersApi {
  ...
  Future<Response<UserResponseDto>> usersControllerCreate({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPageDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPageDto>> usersControllerFindAll({ 
    String? search,
    JsonObject? role,
    JsonObject? status,
    bool? emailVerified,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (role != null) r'role': encodeQueryParameter(_serializers, role, const FullType(JsonObject)),
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(JsonObject)),
      if (emailVerified != null) r'emailVerified': encodeQueryParameter(_serializers, emailVerified, const FullType(bool)),
      if (includeDeleted != null) r'includeDeleted': encodeQueryParameter(_serializers, includeDeleted, const FullType(bool)),
    ...
    UserPageDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserPageDto),
      ) as UserPageDto;
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponseDto>> usersControllerFindOne({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponseDto>> usersControllerRemove({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponseDto>> usersControllerUpdate({ 
    required String id,
