...
class QuestsApi {
  ...
  const QuestsApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<JsonObject>>> questsControllerGetMine({ 
    String? locale,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> questsControllerReroll({ 
    required String id,
    String? locale,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/quests/me/{id}/reroll'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
